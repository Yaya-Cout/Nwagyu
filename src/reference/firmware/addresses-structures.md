...
| 0x8   | 4            | uint32 | Magic (0xF00DC0DE)                   | Determine if the kernel header is valid     |
| 0xC   | 8            | string | Version                              | Version number of the kernel, like `23.2.5` |
| 0x14  | 8            | string | Patch level                          | Commit of the kernel, like `cba3ef2`        |
| 0x1C  | 4            | uint32 | Magic (0xF00DC0DE)                   | Determine if the kernel header is valid     |
